			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo site_url('appusers');?>">App User List</a> <span class="divider"></span></li>
				<li>Search Result</li>
			</ul>
			...
			?>
				<div class="form-group">
			  	...
			  	<a href='<?php echo site_url('appusers');?>' class="btn btn-default">Reset</a>
			</form>
			...
			<table class="table table-striped table-bordered">
				...
				?>
						<tr>
							...
							<td><a href='<?php echo site_url('appusers/detail/'.$appuser->id);?>'>Detail</a></td>
							<?php if(in_array('ban',$allowed_accesses)):?>
							<td>
