			<ul class="breadcrumb">
				...
				<li>
					<a href="<?php echo site_url('inquiries');?>">Inquiry List</a>
					<span class="divider"></span>
				</li>
				<li>Search List</li>
			</ul>
			...
			?>
				<div class="form-group">
			  	...
			  	<a href='<?php echo site_url('inquiries');?>' class="btn btn-default">Reset</a>
			<?php echo form_close(); ?>
			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					...
					<td><a href='<?php echo site_url('inquiries/detail/'.$inquiry->id);?>'>Detail</a></td>
